...
public class Permutation extends Variable {
	 ...
	 * 
	 * // sort value and store index as fragment order for(int i = 0; i < size_-1;
	 * i++){ for(int j = i+1; j < size_; j++) { if(randomSequence[i] >
	 ...
	 * 
	 * @param size
	 *            Length of the permutation This constructor has been contributed by
	 *            Madan Sathe
	 */
