...
public class WASFGA extends Algorithm {
	...
	/**
	 * Update lower bounds (ideal point in a minimization problem) of the
	 * Achievement Scalarizing Function considering the values of the given
	 * <code>Solution</code>
	 * 
	 * @param individual
	 */
	...
	/**
	 * Update upper bounds (nadir point in a minimization problem) of the
	 * Achievement Scalarizing Function considering the values of the given
	 * <code>Solution</code>
	 * 
	 * @param individual
	 ...
	 * problem) of the Achievement Scalarizing Function considering the values of
	 * the given <code>Solution</code>
	 * 
	 * @param individual
	 */
	...
	/**
	 * Initialize nadir and ideal points of the Achievement Scalarizing Function to
	 * the worst values
	 */
