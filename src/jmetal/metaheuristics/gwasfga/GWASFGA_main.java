...
public class GWASFGA_main {
	 ...
	 *             jmetal.metaheuristics.gwasfga.GWASFGA_main problemName
	 *             weightsDirectory - jmetal.metaheuristics.gwasfga.GWASFGA_main
	 *             problemName paretoFrontFile weightsDirectory
	 * 
	 *             The weightsDirectory is a folder containing the weights vector
	 *             files. The name of these files is WND_P.txt, where N is the
	...
	public static void main(String[] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
		...
		algorithm.setInputParameter("asfInUtopian",
				new AchievementScalarizingFunction(problem.getNumberOfObjectives()));
