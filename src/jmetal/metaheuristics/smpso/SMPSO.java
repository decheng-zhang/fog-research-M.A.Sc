...
public class SMPSO extends Algorithm {
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		while (iteration_ < maxIterations_) {
			...
			distance_.crowdingDistanceAssignment(leaders_, problem_.getNumberOfObjectives());
			/*
			 * if ((iteration_ %10 == 0) && (indicators != null) && (requiredEvaluations ==
			 * 0)) { SolutionSet finalset = leaders_.getSolutionsList_(); double HV =
			 * indicators.getHypervolume(finalset);
			 * //System.out.println("are you still working---->" +
			 * (HV)+"lll"+(indicators.getTrueParetoFrontHypervolume())); if (HV >= (0.98 *
			...
			// leaders_.printFeasibleFUNnVAR("DE_FUN_smPSONSGA-"+(runtimes)) ;
		runtimes++;
		return this.leaders_.getSolutionsList_().feasibleEnforcement();
	} // execute
