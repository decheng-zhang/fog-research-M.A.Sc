 ...
 * command line program just by typing: "java jmetal.qualityIndicator.Spread
 * <solutionFrontFile> <trueFrontFile>". This metric is only applicable to two
 * bi-objective problems. Reference: Deb, K., Pratap, A., Agarwal, S.,
 * Meyarivan, T.: A fast and elitist multiobjective genetic algorithm: NSGA-II.
...
public class Spread {
	 ...
	 * <code>double []</code>, and the number of objectives, the method returns the
	 * value of the metric.
	 * 
	 * @param front
	 *            The front.
	...
	public static void main(String args[]) {
		String[] filename = new String[] {
				 ...
				 * "NSGAII/FogPlanningProblem50010/test.t",
				 */
				"nove2/30-10.pf", "nove2/35-10.pf", "nove2/40-10.pf", "nove2/45-10.pf", "nove2/50-10.pf",
				"nove2/55-10.pf", "nove2/60-10.pf", "nove2/65-10.pf", "nove2/70-10.pf", "nove2/75-10.pf",
				"nove2/80-10.pf", "nove2/85-10.pf", "nove2/90-10.pf", "nove2/95-10.pf" };
		if (args.length < 2) {
			/*
			 * System.err.println("Spread::Main: Error using Spread. Usage: \n java " +
			 * "Spread <FrontFile> <TrueFrontFile>  " + "<getNumberOfObjectives>");
			 * System.exit(1); }
			 */// if
			for (int i = 0; i < 14; i++) {
				...
				double[][] solutionFront = utils_.readFront(filename[i]);
				double[][] trueFront = utils_.readFront(filename[i]);
