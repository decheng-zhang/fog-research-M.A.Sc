...
public class R2 {
	...
	/**
	 * Constructor Creates a new instance of the R2 indicator for a problem with two
	...
	/**
	 * Returns the R2 indicator of a given population, using as a reference point 0,
	 * 0. Normalization is using taking into account the population itself
	 * 
	 * @param set
	 * @return
	 */
