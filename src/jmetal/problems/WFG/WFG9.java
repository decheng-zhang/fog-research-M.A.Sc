...
public class WFG9 extends WFG {
	...
	/**
	 * Creates a default WFG9 with 2 position-related parameters, 4 distance-related
	...
	public float[] t1(float[] z, int k) {
		...
		for (int i = 0; i < z.length - 1; i++) {
			...
			result[i] = (new Transformations()).b_param(z[i], aux, (float) 0.98 / (float) 49.98, (float) 0.02,
					(float) 50);
		}
