...
public class Poloni extends Problem {
	...
	public void evaluate(Solution solution) throws JMException {
		final double A1 = 0.5 * Math.sin(1.0) - 2 * Math.cos(1.0) + Math.sin(2.0) - 1.5 * Math.cos(2.0); // !< Constant
																											// A1
		final double A2 = 1.5 * Math.sin(1.0) - Math.cos(1.0) + 2 * Math.sin(2.0) - 0.5 * Math.cos(2.0); // !< Constant
																											// A2
		...
		double B1 = 0.5 * Math.sin(x[0]) - 2 * Math.cos(x[0]) + Math.sin(x[1]) - 1.5 * Math.cos(x[1]);
		double B2 = 1.5 * Math.sin(x[0]) - Math.cos(x[0]) + 2 * Math.sin(x[1]) - 0.5 * Math.cos(x[1]);
