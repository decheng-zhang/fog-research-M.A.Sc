...
public class MOCHC_Settings extends Settings {
	...
	public Algorithm configure(Properties configuration) throws JMException {
		...
		initialConvergenceCount_ = Double.parseDouble(
				configuration.getProperty("initialConvergenceCount", String.valueOf(initialConvergenceCount_)));
		preservedPopulation_ = Double
				.parseDouble(configuration.getProperty("preservedPopulation", String.valueOf(preservedPopulation_)));
