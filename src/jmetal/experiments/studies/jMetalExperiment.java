...
public class jMetalExperiment extends Experiment {
	...
	public void algorithmSettings(String problemName, int problemIndex, Algorithm[] algorithm)
		...
		try {
			...
			// algorithm[0] = new
			// SMPSORandomArchive_Settings(problemName).configure(parameters[0]);
			// algorithm[1] = new
			// SMPSORandomSwarm_Settings(problemName).configure(parameters[1]);
			// algorithm[2] = new
			// SMPSOhvRandomArchive_Settings(problemName).configure(parameters[2]);
	...
	public static void main(String[] args) throws JMException, IOException {
		...
		// exp.algorithmNameList_ = new
		// String[]{"SMPSO","SMPSOArchiveRandom","SMPSOCell2","SMPSOhv3","SMPSOhvRandomArchive"};
		// //, "SMSEMOA","NSGA-II"};
		...
		// "SMPSOCell2"};
		exp.problemList_ = new String[] { "ZDT1", "ZDT2", "ZDT3", "ZDT4", "ZDT6", "DTLZ1", "DTLZ2", "DTLZ3", "DTLZ4",
				"DTLZ5", "DTLZ6", "DTLZ7", "WFG1", "WFG2", "WFG3", "WFG4", "WFG5", "WFG6", "WFG7", "WFG8", "WFG9" };

		exp.paretoFrontFile_ = new String[] { "ZDT1.pf", "ZDT2.pf", "ZDT3.pf", "ZDT4.pf", "ZDT6.pf", "DTLZ1.3D.pf",
				"DTLZ2.3D.pf", "DTLZ3.3D.pf", "DTLZ4.3D.pf", "DTLZ5.3D.pf", "DTLZ6.3D.pf", "DTLZ7.3D.pf", "WFG1.pf",
				"WFG2.pf", "WFG3.pf", "WFG4.pf", "WFG5.pf", "WFG6.pf", "WFG7.pf", "WFG8.pf", "WFG9.pf" };
		...
		problems = new String[] { "ZDT1", "ZDT2", "ZDT3", "ZDT4", "ZDT6", "DTLZ1", "DTLZ2", "DTLZ4", "DTLZ5", "DTLZ6",
