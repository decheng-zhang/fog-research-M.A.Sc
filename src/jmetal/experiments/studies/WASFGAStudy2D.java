...
/**
 * @author Rubén Saborido Infantes Class implementing an example of experiment
 *         using WASFGA as base algorithm. The experiment consisting in studying
 *         WASFGA in several problems
 */
public class WASFGAStudy2D extends Experiment {
	...
	public static void main(String[] args) throws JMException, IOException {
		...
		exp.problemList_ = new String[] { "ZDT1", "DTLZ1", "WFG1" };

		exp.paretoFrontFile_ = new String[] { "ZDT1.pf", "DTLZ1.2D.pf", "WFG1.2D.pf" };
		...
		for (int indexOfProblem = 0; indexOfProblem < exp.problemList_.length; indexOfProblem++) {
			referencePoints[indexOfProblem] = new ReferencePoint(ReferencePoint.ReferencePointType.ACHIEVABLE,
					exp.paretoFrontDirectory_ + exp.paretoFrontFile_[indexOfProblem]);
			// referencePoints[indexOfProblem] = new ReferencePoint("."+exp.experimentName_
			// + "/data/WASFGA/" + exp.problemList_[indexOfProblem] +
			// "/REFERENCE_POINTS.rl");
		}
