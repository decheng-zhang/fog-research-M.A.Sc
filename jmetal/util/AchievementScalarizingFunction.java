...
/**
 * This class models the achievement scalarizing function (ASF) defined by
 * Wierzbicki
 * 
 * @author Rubén
 */
public class AchievementScalarizingFunction {
	...
	/**
	 * Construct an empty ASF given a reference point, the nadir and the ideal
	 * points (the augmentation coefficient is 0.001)
	 * 
	 ...
	 */
	public AchievementScalarizingFunction(ReferencePoint referencePoint, double[] nadir, double[] ideal)
			throws CloneNotSupportedException {
	...
	/**
	 * Construct an empty ASF given a reference point, the nadir and the ideal
	 * points, and the augmentation coefficient
	 * 
	 * @param referencePoint
	 *            The reference point
	 * @param nadir
	 ...
	 * @throws CloneNotSupportedException
	 */
	public AchievementScalarizingFunction(ReferencePoint referencePoint, double[] nadir, double[] ideal, double p)
			throws CloneNotSupportedException {
		this.referencePoint_ = referencePoint;
		this.nadir_ = nadir.clone();
		this.ideal_ = ideal.clone();
	 ...
	 * 
	 * @param objective
	 *            Component of the reference point to modify
	 * @param referenceValue
	 *            New value of the specified component
	 */
	 ...
	 * 
	 * @param nadir
	 *            The nadir point used in the ASF
	 */
	 ...
	 * 
	 * @param objective
	 *            Component of the nadir point to modify
	 * @param value
	 *            New value of the specified component
	 */
	 ...
	 * 
	 * @param nadir
	 *            The ideal point used in the ASF
	 */
	 ...
	 * 
	 * @param objective
	 *            Component of the ideal point to modify
	 * @param value
	 *            New value of the specified component
	 */
	 ...
	 * 
	 * @param p
	 *            The augmentation coefficient used in the ASF
	 */
	...
	/**
	 * Return the normalized value of the ASF, given an objective vector and a
	 * weights vector
	 * 
	 * @param objectives
	 *            Objective vector
	...
	public double evaluateNormalizing(double[] objectives, double[] weights) {
		...
		first_sum = -1e10;
		for (component_index = 0; component_index < this.referencePoint_.size(); component_index++) {
			normalizedDifference = (objectives[component_index] - this.referencePoint_.get(component_index))
					/ (this.nadir_[component_index] - this.ideal_[component_index]);
	...
	/**
	 * Return the value of the ASF for each solution in a <code>SolutionSet</code>
	 * and for each weight vector in a set of weight vectors
	 * 
	 * @param solutionSet
	 *            Set of solutions
	 * @param weights
	...
	/**
	 * Return the value of the ASF for each solution in a <code>SolutionSet</code>
	 * and for each weight vector in a list of weight vectors
	 * 
	 * @param solutionSet
	 *            Set of solutions
	 * @param weights
	...
	/**
	 * Return the normalized value of the ASF for each solution in a
	 * <code>SolutionSet</code> and for each weight vector in a set of weight
	 * vectors
	 * 
	 * @param solutionSet
	 *            Set of solutions
	 * @param weights
	 *            Set of weight vectors
	 * @return The normalized value of the ASF for each solution and each weight
	 *         vector
	 */
	...
	/**
	 * Return the normalized value of the ASF for each solution in a
	 * <code>SolutionSet</code> and for each weight vector in a list of weight
	 * vectors
	 * 
	 * @param solutionSet
	 *            Set of solutions
