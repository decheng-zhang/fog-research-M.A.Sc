...
public class ViolationThresholdComparator implements IConstraintViolationComparator {
	...
	public int compare(Object o1, Object o2) {
		...
		overall1 = ((Solution) o1).getNumberOfViolatedConstraint() * ((Solution) o1).getOverallConstraintViolation();
		overall2 = ((Solution) o2).getNumberOfViolatedConstraint() * ((Solution) o2).getOverallConstraintViolation();
	...
	/**
	 * Returns true if solutions s1 and/or s2 have an overall constraint violation <
	 * 0
	 */
	public boolean needToCompare(Solution o1, Solution o2) {
		...
		double overall1, overall2;
		overall1 = Math
				.abs(((Solution) o1).getNumberOfViolatedConstraint() * ((Solution) o1).getOverallConstraintViolation());
		overall2 = Math
				.abs(((Solution) o2).getNumberOfViolatedConstraint() * ((Solution) o2).getOverallConstraintViolation());
