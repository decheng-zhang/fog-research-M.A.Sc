...
public class ParetoDominance {
	 ...
	 * @param v2
	 *            Point2
	 * @return -1 if Point1 dominates Point2, 1 if Point2 dominates Point1, and 0 if
	 *         no one dominate the other
	 */
	public static int checkParetoDominance(double[] v1, double[] v2) {
		int dominate1; // indicates if some objective of solution1 dominates the same objective in
						// solution2
