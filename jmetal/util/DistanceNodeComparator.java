...
public class DistanceNodeComparator implements Comparator {
	 ...
	 * @param o2
	 *            Object representing a DistanceNode
	 * @return -1 if the distance of o1 is smaller than the distance of o2, 0 if the
	 *         distance of both are equals, and 1 if the distance of o1 is bigger
	 *         than the distance of o2
	 */
