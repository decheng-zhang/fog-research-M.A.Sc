 ...
 * compared when solving the benchmarks, and the hypervolume, spread and
 * additive epsilon indicators are used for performance assessment. This
 * experiment assumes that the reference Pareto fronts are unknown.
 */
public class ZDTStudy2 extends Experiment {
	...
	public static void main(String[] args) throws JMException, IOException {
		...
		exp.algorithmNameList_ = new String[] { "NSGAII", "SMPSO", "GDE3" };
