...
public class NSGAII_Settings extends Settings {
	...
	public NSGAII_Settings(String problem) {
		...
		mutationProbability_ = 0.1;// 1.0/problem_.getNumberOfVariables() ;
		crossoverProbability_ = 0.9;
		mutationDistributionIndex_ = 18.0;
		crossoverDistributionIndex_ = 18.0;
	} // NSGAII_Settings
	...
	public Algorithm configure() throws JMException {
		...
		// algorithm.setInputParameter("indicators", new QualityIndicator(problem_,
		// paretoFrontFile_));
