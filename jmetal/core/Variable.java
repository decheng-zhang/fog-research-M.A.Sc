...
public abstract class Variable implements Serializable {
	...
	/**
	 * Gets the double value representating the encodings.variable. It is used in
	 ...
	 * belonging to a subclass of <code>Variable</code> have an upper bound, a call
	 * to this method is considered a fatal error by default, and the program is
	 * terminated. Those classes requiring this method must redefine it.
	 */
	 ...
	 * method is considered a fatal error by default and the program is terminated.
