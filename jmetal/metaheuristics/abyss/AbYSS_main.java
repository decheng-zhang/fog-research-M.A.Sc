...
import jmetal.problems.carleton.FPP.FogPlanningProblem3010;
...
public class AbYSS_main {
	...
	public static void main(String[] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
		...
		if (args.length == 1) {
			...
			problem = new FogPlanningProblem3010("Int");
		...
		algorithm.setInputParameter("refSet1Size", 100);
		algorithm.setInputParameter("refSet2Size", 100);
