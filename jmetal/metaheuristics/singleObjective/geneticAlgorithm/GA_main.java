...
public class GA_main {
	...
	public static void main(String[] args) throws JMException, ClassNotFoundException {
		 ...
		 * 20.0) ; crossover = CrossoverFactory.getCrossoverOperator("SBXCrossover",
		 * parameters);
		 * 
		 * parameters = new HashMap() ; parameters.put("probability",
		 * 1.0/problem.getNumberOfVariables()) ; parameters.put("distributionIndex",
		 * 20.0) ; mutation = MutationFactory.getMutationOperator("PolynomialMutation",
		 * parameters);
		 */
