...
/**
 * Class implementing the NSGA-II algorithm. This implementation of NSGA-II
 * makes use of a QualityIndicator object to obtained the convergence speed of
 * the algorithm. This version is used in the paper: A.J. Nebro, J.J. Durillo,
 * C.A. Coello Coello, F. Luna, E. Alba "A Study of Convergence Speed in
 * Multi-Objective Metaheuristics." To be presented in: PPSN'08. Dortmund.
 * September 2008.
 * 
...
public class NSGAIIAdaptive_main {
	...
	public static void main(String[] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
		...
		// getOffspring[2] = new
		// NonUniformMutationOffspring(1.0/problem.getNumberOfVariables(), 0.5, 150000);

		/*
		 * Offspring[] getOffspring = new Offspring[2]; double CR, F; getOffspring[0] =
		 * new SBXCrossoverOffspring( 0.9, // crossover probability 20); // distribution
		 * index for crossover
		 * 
		 * getOffspring[1] = new PolynomialOffspring(1.0/problem.getNumberOfVariables(),
		 * 20);
		 */
