 ...
 * @version 1.0 This class implements the mQAP problem. Please notice that this
 *          class is also valid for the case m = 1 (mono-objective version of
 *          the problem)
 */
public class mQAP extends Problem {
	 ...
	 * 
	 * @param fileName:
	 *            name of the file containing the instance
	 */
